...
export default function RootLayout({ children }: { children: ReactNode }) {
  return (
    <html lang="fr">
      <body className="relative overflow-x-hidden text-white min-h-screen bg-[#0b1220] font-inter">
        {/* Fond horizon (image seule) */}
        <div className="background-horizon" />

        {/* (Optionnel) halo central doux derrière le hero */}
        ...
        {/* ⚠️ plus de .horizon / .horizon-line ici */}
      </body>
    </html>
  );
}
